...
sudo electron-osx-sign --identity="Developer ID Application: Jake Gealer (S7UG4ZL2KJ)" --keychain=/Library/Keychains/System.keychain ./build/MagicCap-darwin-x64/MagicCap.app
